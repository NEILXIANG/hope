...
--
-- Host: localhost    Database: lejiehui
-- ------------------------------------------------------
...
CREATE TABLE `items` (
  ...
  `product_no` varchar(256) DEFAULT '',
  `creation_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `INDEX_SHOP_ID` (`shop_id`),
  KEY `INDEX_USER_ID` (`user_id`),
  KEY `INDEX_CAT_ID` (`category_id`)
...
CREATE TABLE `shops` (
  ...
  `creation_time` int(14) DEFAULT NULL,
  `update_time` int(14) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(256) NOT NULL DEFAULT '/avatar/rabbit-gray.png',
...
-- Dump completed on 2013-07-20 21:13:05
